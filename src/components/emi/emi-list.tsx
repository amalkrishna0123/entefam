            ...
            <div className="flex items-center gap-4 min-w-0">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {parseInt(emi.dueDate) === new Date().getDate() && (
                ...
                <div className="flex items-center gap-2 text-xs text-[var(--text-tertiary)] mt-0.5">
                  <span>Due on day {emi.dueDate}</span>
                </div>
              </div>
            </div>
      ...
      <Modal isOpen={!!editEmi} onClose={() => setEditEmi(null)} title="Edit EMI">
        {editEmi && (
          <form onSubmit={handleUpdate} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="edit-due">Due Date (Day of Month)</Label>
              <Input id="edit-due" type="number" min="1" max="31" value={editEmi.dueDate} onChange={(e) => setEditEmi({...editEmi, dueDate: e.target.value})} required />
            </div>
