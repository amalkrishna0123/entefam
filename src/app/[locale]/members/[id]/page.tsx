      ...
      <div className="grid gap-8 lg:grid-cols-12">
        ...
        <div className="lg:col-span-4 space-y-6">
          <Card className="overflow-hidden border-[var(--border-strong)] bg-[var(--bg-surface)] shadow-2xl shadow-black/5 rounded-[2.5rem]">
            <div style={{marginBottom:"10px"}} className="h-32 bg-gradient-to-br from-[var(--accent)]/20 via-[var(--accent)]/5 to-transparent" />
            <CardContent className="relative pt-0 px-8 pb-10 text-center">
